...
const SURVIVAL_ZOMBIE_MIN_GRAB_DURATION: float = 1.35
const SURVIVAL_ZOMBIE_GRAB_SLOW_PER_ZOMBIE: float = 0.18
const SURVIVAL_ZOMBIE_GRAB_MIN_SPEED: float = 0.38
const SURVIVAL_ZOMBIE_RELEASE_CONTACT_RADIUS: float = 31.0
const SURVIVAL_ZOMBIE_SPAWN_STEP: float = 0.36
const SURVIVAL_ESCAPIST_ABILITY_COOLDOWN: float = 20.0
const SURVIVAL_RAT_RESCUE_RANGE_MAP_RATIO: float = 0.5
const SURVIVAL_RAT_RESCUE_SPEED_BONUS_PER_RESCUE: float = 0.06
const SURVIVAL_FLY_COUNTER_DURATION: float = 1.0
...
const ONE_WAY_COLOR := Color(0.12, 0.62, 1.0, 0.42)
